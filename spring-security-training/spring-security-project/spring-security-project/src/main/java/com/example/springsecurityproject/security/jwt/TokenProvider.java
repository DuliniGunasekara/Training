...
//        }
    ...
    public String createToken(final Authentication authentication) {
        ...
        return Jwts.builder().setSubject(authentication.getName()).claim("auth", authorities).signWith(SignatureAlgorithm.HS256, BASE_64_SECRET).setExpiration(tokenValidity).compact();
    }
